...
const RelatedDoctors = ({ speciality, docId }) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-text_primary md:mx-10'>
      <h1 className='text-3xl font-semibold'>Related Doctors</h1>
      <p className='sm:w-1/3 text-center text-sm text-text_secondary'>Simply browse through our extensive list of trusted doctors</p>
